<template>
  <section class="background-gray">
    ...
    <div class="competencias">
      <!-- Linguagens -->
      <div class="competencia-list azul">
        <h3>Linguagens<br>de Programação</h3>
        <ul>
          <li>
      ...
      <div class="competencia-list ciano">
        <h3>Linguagens<br>de Marcação</h3>
        <ul>
          <li>
            <svg viewBox="0 0 24 24">
      ...
      <!-- Frameworks -->
      <div class="competencia-list roxo">
        <h3>Frameworks</h3>
        <ul>
          <li>
            <svg viewBox="0 0 24 24">
      ...
      <!-- Banco de Dados -->
      <div class="competencia-list verde">
      ...
      <!-- Outros -->
      <div class="competencia-list amarelo">
        <h3>Outros</h3>
        <ul>
          <li>
            <svg viewBox="0 0 24 24">
...
.competencia-list h3{
  border: 10px solid attr(data-color);
  position: relative;
  padding-left: 20px;
  font-size: 24px;
  font-weight: bold;
...
.competencia-list.azul h3::before{
  background-color: #3498DB;
}
.competencia-list.roxo h3::before{
  background-color: #9B59B6;
}
.competencia-list.ciano h3::before{
  background-color: #48dbfb;
}
.competencia-list.verde h3::before{
  background-color: #00B894;
}
.competencia-list.amarelo h3::before{
...
.competencia-list ul li{
  margin-bottom: 10px;
  display: flex;
  align-items: center;
}

.competencia-list ul li svg{
  height: 32px;
  width: 32px;
  margin-right: 10px;
}

.competencia-list.azul ul li svg{
  color: #3498DB;
}
.competencia-list.roxo ul li svg{
  color: #9B59B6;
}
.competencia-list.ciano ul li svg{
  color: #48dbfb;
}
.competencia-list.verde ul li svg{
  color: #00B894;
}
.competencia-list.amarelo ul li svg{
  color: #FBC531;
}
</style>
